...
`r nrow(revdeps)` packages that depend on it. We also have edges between the
...
There are only `r english::english(sum(revdeps$Repo == "CRAN"))` packages
