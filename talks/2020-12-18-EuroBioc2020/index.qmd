...
abstract: |
  ...
  Currently, there are three key ecosystems, the [Seurat](https://satijalab.org/seurat/) package (available from CRAN), Bioconductor's [SingleCellExperiment](https://bioconductor.org/packages/SingleCellExperiment/) object and the [AnnData](https://anndata.readthedocs.io/en/latest/index.html) Python object used by the [Scanpy](https://scanpy.readthedocs.io/en/stable/)
  package.
  While these platforms each have strengths and weaknesses most analysts are likely to only use one of them. In this talk, I discuss how interoperability between R and Python can allow us to take advantage of these platforms strengths and avoid unnecessary reimplementation of methods.
